...
namespace CodeBase.Player
{
    ...
    public class Bicycle : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            rearPend = _rearPendulumn;
            
            frontWheelAPD = _collFrontWheelCollider.forceAppPointDistance;
        ...
        private void FixedUpdate()
        {
            ...
            _collFrontWheelCollider.forceAppPointDistance = frontWheelAPD - bikeSpeed / 1000;
        ...
        {
            if (!_crashed && _playerInput.Vertical == 0 && !linkToStunt.stuntIsOn ||
        ...
        private void CrashHappened()
        {
            if ((this.transform.localEulerAngles.z >= _crashAngleSideFall01 &&
                 this.transform.localEulerAngles.z <= _crashAngleSideFall02) && !linkToStunt.stuntIsOn ||
                (this.transform.localEulerAngles.x >= _crashAngleFrontFall &&
                 this.transform.localEulerAngles.x <= _crashAngleBackFall && !linkToStunt.stuntIsOn))
            {
